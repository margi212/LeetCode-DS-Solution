...
class Tree
{
     public ArrayList<Integer> diagonal(Node root) {
        ...
        diagonalView(root,0,map,maxSlope);    
      ...
      private void diagonalView(Node root,int slope,HashMap<Integer, List<Integer>> map,int[] maxSlope){
        if(root == null) 
            return;
        ...
        diagonalView(root.left,slope+1,map,maxSlope);    
        diagonalView(root.right,slope,map,maxSlope);    
